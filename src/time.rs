...
impl SearchLimits {
    ...
    fn score_stability_scale(&self, depth: i32, score_stability: usize) -> f32 {
        if depth < 4 {
            return 1.0;
        }
        1.2 - 0.04 * score_stability as f32
    }
