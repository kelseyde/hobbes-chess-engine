...
fn alpha_beta(board: &Board,
    ...
    if best_move.exists() {
        ...
        let nmp_refutation = !root_node && td.ss[ply - 1].mv.is_none();
        ...
        let quiet_bonus = quiet_history_bonus(depth)
            ...
            + nmp_refutation as i16 * quiet_hist_nmp_refut_bonus() as i16
        ...
        let quiet_malus = quiet_history_malus(depth)
            ...
            + nmp_refutation as i16 * quiet_hist_nmp_refut_malus() as i16;
        ...
        let cont_bonus = cont_history_bonus(depth)
            ...
            + nmp_refutation as i16 * cont_hist_nmp_refut_bonus() as i16
        ...
        let cont_malus = cont_history_malus(depth)
            ...
            + nmp_refutation as i16 * cont_hist_nmp_refut_malus() as i16;
