...
fn alpha_beta(board: &Board,
    ...
    if best_move.exists() {
        ...
        let beat_static_eval = !in_check && best_score >= beta && best_score > static_eval;
        ...
        let quiet_bonus = quiet_history_bonus(depth)
            ...
            + beat_static_eval as i16 * quiet_hist_eval_bonus() as i16
        ...
        let cont_bonus = cont_history_bonus(depth)
            ...
            + beat_static_eval as i16 * cont_hist_eval_bonus() as i16
        ...
        let cont_malus = cont_history_malus(depth)
            ...
            + beat_static_eval as i16 * cont_hist_eval_malus() as i16;
