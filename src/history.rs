...
impl CorrectionHistory {
    ...
    pub fn get(&self, stm: Side, key: u64) -> i32 {
        ...
        self.entries[stm][index] / Self::GRAIN
    }
    ...
    pub fn update(&mut self, stm: Side, key: u64, depth: i32, diff: i32) {
        ...
        let scaled_diff = diff * Self::GRAIN;
        let weight = 16.min(depth + 1);

        let update = *entry * (Self::GRAIN - weight) + scaled_diff * weight;
        *entry = (update / Self::GRAIN).clamp(-Self::MAX, Self::MAX);
    }
