...
tunable_params! {
    ...
    from_hist_bonus_scale       = 60, 40, 140, 20;
    from_hist_bonus_offset      = 38, 0, 100, 12;
    from_hist_bonus_max         = 600, 500, 800, 50;
    from_hist_malus_scale       = 60, 40, 140, 20;
    from_hist_malus_offset      = 38, 0, 100, 12;
    from_hist_malus_max         = 600, 500, 800, 50;
    to_hist_bonus_scale         = 60, 40, 140, 20;
    to_hist_bonus_offset        = 38, 0, 100, 12;
    to_hist_bonus_max           = 600, 500, 800, 50;
    to_hist_malus_scale         = 60, 40, 140, 20;
    to_hist_malus_offset        = 38, 0, 100, 12;
    to_hist_malus_max           = 600, 500, 800, 50;
