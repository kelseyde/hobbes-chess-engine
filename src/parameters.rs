...
tunable_params! {
    ...
    lmr_quiet_hist_offset       = 512, -2048, 2048, 256;
    lmr_quiet_hist_divisor      = 16384, 8192, 32768, 2048;
    lmr_noisy_hist_offset       = 512, -2048, 2048, 256;
    lmr_noisy_hist_divisor      = 16384, 8192, 32768, 2048;
