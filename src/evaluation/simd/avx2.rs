...
pub unsafe fn clamp_i32(x: __m256i, min: __m256i, max: __m256i) -> __m256i {
    unsafe { _mm256_max_epi32(_mm256_min_epi32(x, max), min) }
}

#[inline(always)]
pub unsafe fn shift_left_mul_high_i16(a: __m256i, b: __m256i) -> __m256i {
    const SHIFT: i32 = 16 - L0_SHIFT as i32;
    unsafe { _mm256_mulhi_epi16(_mm256_slli_epi16::<SHIFT>(a), b) }
}
...
pub unsafe fn shift_right_i32<const SHIFT: i32>(a: __m256i) -> __m256i {
    unsafe { _mm256_srai_epi32::<SHIFT>(a) }
}

#[inline(always)]
pub unsafe fn shift_left_i32<const SHIFT: i32>(a: __m256i) -> __m256i {
    unsafe { _mm256_slli_epi32::<SHIFT>(a) }
}
