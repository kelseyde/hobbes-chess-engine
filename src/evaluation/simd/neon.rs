...
pub unsafe fn clamp_i16(x: int16x8_t, min: int16x8_t, max: int16x8_t) -> int16x8_t {
    unsafe { vmaxq_s16(vminq_s16(x, max), min) }
}

#[inline(always)]
pub unsafe fn splat_i32(a: i32) -> int32x4_t {
    unsafe { vdupq_n_s32(a) }
}

#[inline(always)]
pub unsafe fn splat_i32_as_u8(a: i32) -> int8x16_t {
    unsafe { vreinterpretq_s8_s32(vdupq_n_s32(a)) }
}
...
pub unsafe fn clamp_i32(x: int32x4_t, min: int32x4_t, max: int32x4_t) -> int32x4_t {
    unsafe { vmaxq_s32(vminq_s32(x, max), min) }
}
...
pub unsafe fn shift_left_mul_high_i16(a: int16x8_t, b: int16x8_t) -> int16x8_t {
    ...
    unsafe { vqdmulhq_s16(vshlq_n_s16::<SHIFT>(a), b) }
}
...
pub unsafe fn packus(a: int16x8_t, b: int16x8_t) -> uint8x16_t {
    unsafe { vqmovun_high_s16(vqmovun_s16(a), b) }
}
...
pub unsafe fn shift_right_i32<const SHIFT: i32>(a: int32x4_t) -> int32x4_t {
    unsafe { vshrq_n_s32::<SHIFT>(a) }
}

#[inline(always)]
pub fn shift_left_i32<const SHIFT: i32>(a: int32x4_t) -> int32x4_t {
    unsafe { vshlq_n_s32::<SHIFT>(a) }
}

#[inline(always)]
pub fn horizontal_sum_i32<const N: usize>(a: [int32x4_t; N]) -> i32 {
    let mut acc = a[0];
    unsafe {
