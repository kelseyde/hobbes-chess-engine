...
#[rustfmt::skip]
tunable_params! {
    asp_delta_base              = 20, 4, 36, 4;
    asp_delta_min               = 4, 0, 14, 2;
    asp_delta_depth_divisor     = 4, 1, 10, 1;
    ...
    rfp_complexity_mult         = 580, 400, 640, 20;
    rfp_min_margin              = 20, 0, 50, 5;
    ...
    se_double_ext_pv_node       = 20, 10, 30, 5;
    ...
    quiet_hist_bonus_cutnode    = 75, 0, 100, 25;
    ...
    capt_hist_bonus_cutnode     = 75, 0, 100, 25;
    ...
    cont_hist_bonus_cutnode     = 75, 0, 100, 25;
