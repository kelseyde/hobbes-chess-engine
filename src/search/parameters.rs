...
tunable_params! {
    ...
    quiet_bonus_scale           = 238, 80, 280, 40;
    quiet_bonus_offset          = 62, 0, 200, 25;
    quiet_bonus_max             = 1050, 1000, 1600, 100;
    quiet_malus_scale           = 84, 80, 280, 40;
    quiet_malus_offset          = 28, 0, 200, 25;
    quiet_malus_move_mult       = 40, 0, 60, 20;
    quiet_malus_max             = 1306, 1000, 1600, 100;
    capt_bonus_scale            = 243, 80, 280, 40;
    capt_bonus_offset           = 63, 0, 200, 25;
    capt_bonus_max              = 1478, 1000, 1600, 100;
    capt_malus_scale            = 120, 80, 280, 40;
    capt_malus_offset           = 87, 0, 200, 25;
    capt_malus_move_mult        = 40, 0, 60, 20;
    capt_malus_max              = 1231, 1000, 1600, 100;
    cont_bonus_scale            = 83, 80, 280, 40;
    cont_bonus_offset           = 200, 0, 200, 25;
    cont_bonus_max              = 1041, 1000, 1600, 100;
    cont_malus_scale            = 80, 80, 280, 40;
    cont_malus_offset           = 79, 0, 200, 25;
    cont_malus_move_mult        = 40, 0, 60, 20;
    cont_malus_max              = 1087, 1000, 1600, 100;
