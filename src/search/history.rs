...
pub fn check_history_bonus(depth: i32) -> i16 {
    let scale = check_hist_bonus_scale() as i16;
    let offset = check_hist_bonus_offset() as i16;
    let max = check_hist_bonus_max() as i16;
    history_bonus(depth, scale, offset, max)
}

pub fn check_history_malus(depth: i32) -> i16 {
    let scale = check_hist_malus_scale() as i16;
    let offset = check_hist_malus_offset() as i16;
    let max = check_hist_malus_max() as i16;
    history_malus(depth, scale, offset, max)
}
