...
pub struct ContinuationHistory {
    entries: Box<[PieceToHistory<PieceToHistory<i16>>; 4]>,
}
...
impl ContinuationHistory {
    ...
    pub fn clear(&mut self) {
        self.entries = Box::new([[[[[0; 64]; 6]; 64]; 6]; 4])
    }
}
