...
use super::*;
    ...
    history_bonuses!(pcm_quiet_bonus           (pcm_quiet_bonus_scale,     pcm_quiet_bonus_offset,     pcm_quiet_bonus_max),
                     pcm_quiet_malus           (pcm_quiet_bonus_scale,     pcm_quiet_bonus_offset,     pcm_quiet_bonus_max));
    history_bonuses!(pcm_noisy_bonus           (pcm_noisy_bonus_scale,     pcm_noisy_bonus_offset,     pcm_noisy_bonus_max),
                     pcm_noisy_malus           (pcm_noisy_bonus_scale,     pcm_noisy_bonus_offset,     pcm_noisy_bonus_max));
}
pub use bonuses::*;
