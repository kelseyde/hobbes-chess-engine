...
type Neon256 = (uint64x2_t, uint64x2_t);

#[inline(always)]
unsafe fn set1(x: i64) -> Neon256 {
    let v = vdupq_n_u64(x as u64);
    (v, v)
}

#[inline(always)]
unsafe fn setr(a: i64, b: i64, c: i64, d: i64) -> Neon256 {
    (
...
#[inline(always)]
unsafe fn or256(a: Neon256, b: Neon256) -> Neon256 {
    (vorrq_u64(a.0, b.0), vorrq_u64(a.1, b.1))
}

#[inline(always)]
unsafe fn and_not256(a: Neon256, b: Neon256) -> Neon256 {
    (vbicq_u64(b.0, a.0), vbicq_u64(b.1, a.1))
}

#[inline(always)]
unsafe fn sllv256(a: Neon256, shift: Neon256) -> Neon256 {
    (
...
#[inline(always)]
unsafe fn srlv256(a: Neon256, shift: Neon256) -> Neon256 {
    (
...
fn reduce_or2(a: Neon256, b: Neon256) -> u64 {
    unsafe {
        let or = or256(a, b);
...
fn knights_setwise(knights: Bitboard) -> [Neon256; 2] {
...
fn sliders_setwise(orth: Bitboard, diag: Bitboard, blockers: Bitboard) -> [Neon256; 2] {
    let a = 0x0101010101010101i64;
    let h = a << 7;
